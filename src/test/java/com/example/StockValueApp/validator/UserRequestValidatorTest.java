...
class UserRequestValidatorTest {
    ...
    void validateUserRequest_NullUserName_ThrowsException() {
        MandatoryFieldsMissingException exception = assertThrows(
                MandatoryFieldsMissingException.class,
                () -> validator.validateUserRequest(new UserRequestDTO(null, "Password", "email.gmail.com"))
        );
    ...
    void validateUserRequest_IsBlankUserName_ThrowsException() {
        MandatoryFieldsMissingException exception = assertThrows(
                MandatoryFieldsMissingException.class,
                () -> validator.validateUserRequest(new UserRequestDTO("", "Password", "email.gmail.com"))
        );
    ...
    void validateUserRequest_NullPassword_ThrowsException() {
        MandatoryFieldsMissingException exception = assertThrows(
                MandatoryFieldsMissingException.class,
                () -> validator.validateUserRequest(new UserRequestDTO("Username", null, "email.gmail.com"))
        );
    ...
    void validateUserRequest_IsBlankPassword_ThrowsException() {
        MandatoryFieldsMissingException exception = assertThrows(
                MandatoryFieldsMissingException.class,
                () -> validator.validateUserRequest(new UserRequestDTO("Username", "", "email.gmail.com"))
        );
    ...
    void validateUserRequest_NullEmail_ThrowsException() {
        MandatoryFieldsMissingException exception = assertThrows(
                MandatoryFieldsMissingException.class,
                () -> validator.validateUserRequest(new UserRequestDTO("Username", "Password", null))
        );
    ...
    void validateUserRequest_IsBlankEmail_ThrowsException() {
        MandatoryFieldsMissingException exception = assertThrows(
                MandatoryFieldsMissingException.class,
                () -> validator.validateUserRequest(new UserRequestDTO("Username", "Password", ""))
        );
    ...
    void validateUserName_userExists_ThrowsException() {
        ...
        UserAlreadyExistException exception = assertThrows(
                ...
                () -> validator.validateUserName(userRequestDTO)
        );

        assertEquals("User with username: " + userRequestDTO.getUserName() + " already exist. Choose different user name.", exception.getMessage());
    }
    ...
    void validateEmail_UserWithSameEmailAlreadyExist_ThrowsException() {
        ...
        EmailAlreadyExistException exception = assertThrows(
                ...
                () -> validator.validateEmail(userRequestDTO)
        );

        assertEquals("User with email address " + userRequestDTO.getEmail() + " already exist.", exception.getMessage());
    }
    ...
    void validateEmail_UserWithProvidedEmailDoesNotExist_DoesNotThrowException() {
        ...
        assertDoesNotThrow(() -> validator.validateEmail(userRequestDTO));
    }
}